...
class _$ContactUpdateCubitStateTearOff {
  ...
  _Erro error({required String message}) {
    return _Erro(
      message: message,
    );
  }
...
/// @nodoc
abstract class _$ErroCopyWith<$Res> {
  factory _$ErroCopyWith(_Erro value, $Res Function(_Erro) then) =
      __$ErroCopyWithImpl<$Res>;
...
class __$ErroCopyWithImpl<$Res>
  ...
  __$ErroCopyWithImpl(_Erro _value, $Res Function(_Erro) _then)
      : super(_value, (v) => _then(v as _Erro));

  @override
  _Erro get _value => super._value as _Erro;
...
class _$_Erro implements _Erro {
  ...
  @JsonKey(ignore: true)
  @override
  _$ErroCopyWith<_Erro> get copyWith =>
      __$ErroCopyWithImpl<_Erro>(this, _$identity);
...
abstract class _Erro implements ContactUpdateCubitState {
  factory _Erro({required String message}) = _$_Erro;

  String get message;
  @JsonKey(ignore: true)
  _$ErroCopyWith<_Erro> get copyWith => throw _privateConstructorUsedError;
}
